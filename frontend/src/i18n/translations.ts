...
const en: TranslationDict = {
  ...
  'app.hero.desc':
    'Tell us about your skin and goals. We analyze Sephora ingredients, ratings, and reviews to recommend the best products for you.',
...
const fr: TranslationDict = {
  ...
  'app.hero.desc':
    'Décrivez votre peau et vos objectifs. Nous analysons les ingrédients, notes et avis Sephora pour vous recommander les meilleurs produits.',
...
const zh: TranslationDict = {
  ...
  'app.hero.desc':
    '告诉我们你的肤质和需求，我们将根据 Sephora 产品成分、评分和用户评价，为你推荐最合适的护肤方案。',
